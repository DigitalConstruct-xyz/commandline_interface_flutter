...
TextField superTextFieldFactory(
    BehaviorSubject<String> inputStream,
    BehaviorSubject<String> autoFillStream,
    BehaviorSubject<String> onChangedStream,
    FocusNode focusNode,
    {TextInputType keyboardType = TextInputType.text}) {
  //change to take stream, then sink the stream
  //
  TextEditingController controller =
      TextEditingController(); //update the stream with the text
